...
function Navbar(){
    return(
        <nav style={{display:"flex",justifyContent:"space-between",backgroundColor:"rgb(255, 191, 0)",height:"50px"}}>
            ...
            <button onClick={()=>alert('You have logged out from Your account successfully!....')} style={{cursor:"pointer",height:"32px",width:"80px",border:"none",backgroundColor:"red",color:"black",fontSize:"15px",borderRadius:"5px",marginTop:"10px",marginRight:"10px",fontWeight:"bolder"}}>Logout</button>
        </nav>
    )
}
